    ...
    options: [
      {
        ...
        points: 0,
        consequence: "You escalate the hate speech cycle",
        explanation:
          "Creating counter-hate content amplifies division and can trigger more serious conflicts between linguistic communities.",
        legalRisk:
          "Hate speech on social media can result in account suspension, school disciplinary action, and legal consequences under Cameroon's cybercrime laws.",
      },
      {
        text: "Share the video to your story with laughing emojis",
        points: 0,
        consequence: "You amplify regional discrimination to your followers",
        explanation:
          "Sharing discriminatory content spreads harmful stereotypes and makes you complicit in normalizing hate speech.",
        legalRisk:
          "Sharing hate speech makes you legally complicit and can result in the same consequences as creating original hate content.",
      },
      {
        text: "Comment: 'This isn't funny, it's hurtful to Anglophone students'",
        points: 2,
        consequence: "You voice disagreement but may get attacked by other users",
        explanation:
          "Speaking up is important, but isolated comments on viral hate content often get drowned out or trigger harassment.",
      },
      {
        ...
        points: 4,
        consequence: "You counter hate with education and systemic action",
        explanation:
          "Perfect! Using your platform for education while taking concrete action shows real digital leadership and helps prevent escalation.",
        legalRisk:
          "Educational content that promotes unity and counters hate speech is protected and demonstrates positive digital citizenship.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        points: 0,
        consequence: "You spread dangerous political hate speech",
        explanation:
          "Political hate speech has contributed to real violence and arrests in Cameroon. Your amplification makes you part of the problem.",
        legalRisk:
          "Political hate speech can result in arrest and detention, as seen with many young Cameroonians imprisoned for social media posts.",
      },
      {
        text: "Send a private DM: 'Maybe tone it down a bit?'",
        points: 1,
        consequence: "You express mild concern privately",
        explanation:
          "Private disagreement is better than silence, but doesn't address the public harm or educate your mutual followers.",
      },
      {
        text: "Post your own story: 'Political opposition is normal in democracy. Let's discuss issues, not attack people.'",
        points: 3,
        consequence: "You provide counter-narrative to your followers",
        explanation:
          "Creating alternative content helps your followers see different perspectives and promotes democratic values.",
      },
      {
        ...
        points: 4,
        consequence: "You take comprehensive action against political hate",
        explanation:
          "Excellent! Documenting hate speech, reporting it, and creating educational opportunities helps build democratic culture and prevents escalation.",
        legalRisk:
          "Promoting democratic dialogue and reporting hate speech demonstrates good citizenship and helps protect democratic institutions.",
      },
    ],
  },  {
    ...
    options: [
      {
        ...
        points: 0,
        consequence: "You encourage more ethnic hate content",
        explanation:
          "Supporting ethnic stereotyping encourages creators to make more divisive content and normalizes discrimination among viewers.",
        legalRisk:
          "Encouraging hate speech can make you complicit in discrimination and may result in legal consequences under anti-discrimination laws.",
      },
      {
        text: "Watch without engaging and move on",
        points: 1,
        consequence: "You avoid participation but allow hate to spread",
        explanation:
          "Passive consumption still gives the video engagement metrics, and your silence allows harmful stereotypes to go unchallenged.",
      },
      {
        text: "Dislike the video and comment explaining why ethnic stereotypes are harmful",
        points: 3,
        consequence: "You publicly challenge the ethnic hate speech",
        explanation:
          "Public disagreement helps other viewers recognize the harm and shows affected communities they have allies.",
      },
      {
        ...
        points: 4,
        consequence: "You take comprehensive action to counter ethnic hate",
        explanation:
          "Perfect! Combining reporting, education, and direct outreach maximizes impact and helps transform hate into understanding.",
        legalRisk:
          "Creating educational content that celebrates diversity and reports hate speech demonstrates positive digital citizenship.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        points: 0,
        consequence: "You amplify both gender-based and ethnic hate speech",
        explanation:
          "Combining gender stereotypes with ethnic discrimination creates double harm and perpetuates dangerous prejudices affecting real women's safety.",
        legalRisk:
          "Gender-based hate speech combined with ethnic discrimination can result in serious legal consequences and social media restrictions.",
      },
      {
        text: "Reply privately: 'This seems harsh'",
        points: 1,
        consequence: "You express mild disagreement privately",
        explanation:
          "Private disagreement is better than silence but doesn't address the public harm or educate others about intersectional discrimination.",
      },
      {
        text: "Post your own status: 'Women from all backgrounds deserve respect, not stereotypes based on their ethnicity'",
        points: 3,
        consequence: "You counter the hate with positive messaging",
        explanation:
          "Creating counter-narratives helps your contacts see different perspectives and challenges both gender and ethnic stereotypes.",
      },
      {
        ...
        points: 4,
        consequence: "You take comprehensive action against intersectional hate",
        explanation:
          "Excellent! Addressing both the immediate harm and systemic issues while supporting victims shows real leadership in fighting hate speech.",
        legalRisk:
          "Supporting victims and educating about discrimination demonstrates good citizenship and helps create safer communities.",
      },
    ],
  },  
{
    ...
    options: [
      {
        ...
        points: 0,
        consequence: "You amplify religious hate speech to your network",
        explanation:
          "Religious hate speech has led to real violence and displacement in northern Cameroon. Your amplification spreads dangerous intolerance.",
        legalRisk:
          "Religious hate speech violates Cameroon's constitution guaranteeing religious freedom and can result in legal consequences.",
      },
      {
        text: "Mute the thread and block the account",
        points: 1,
        consequence: "You protect yourself but allow religious hate to spread",
        explanation:
          "Personal protection is important, but doesn't address the public harm or help others recognize the dangerous rhetoric.",
      },
      {
        ...
        points: 3,
        consequence: "You publicly defend constitutional rights",
        explanation:
          "Invoking constitutional principles helps educate followers about religious rights and challenges discriminatory narratives.",
      },
      {
        ...
        points: 4,
        consequence: "You transform religious hate into interfaith understanding",
        explanation:
          "Perfect! Using hate speech as an opportunity for education and community building helps prevent future conflicts and builds bridges.",
        legalRisk:
          "Promoting religious tolerance and interfaith dialogue aligns with Cameroon's laws and demonstrates excellent citizenship.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        points: 0,
        consequence: "You encourage live disability-based bullying",
        explanation:
          "Encouraging live mockery of disabilities creates hostile environments and can cause severe psychological harm to the targeted student.",
        legalRisk:
          "Live disability harassment can result in immediate school suspension, legal action, and permanent social media bans.",
      },
      {
        text: "Leave the live stream without commenting",
        points: 1,
        consequence: "You avoid participation but allow public humiliation to continue",
        explanation:
          "While you don't participate, your silence allows the live harassment to continue affecting the targeted student and other viewers.",
      },
      {
        text: "Comment: 'This is disability discrimination and bullying. Everyone deserves respect and inclusion.'",
        points: 3,
        consequence: "You publicly defend disability rights during the live stream",
        explanation:
          "Public defense during live harassment helps interrupt the bullying and shows other viewers that this behavior is unacceptable.",
      },
      {
        ...
        points: 4,
        consequence: "You take immediate comprehensive action to stop the harassment",
        explanation:
          "Excellent! Immediate reporting can stop live harassment, while documentation and support help address both immediate and long-term harm.",
        legalRisk:
          "Reporting live harassment and supporting victims demonstrates good citizenship and helps schools meet legal inclusion requirements.",
      },
    ],
  },  {
    ...
    options: [
      {
        ...
        points: 0,
        consequence: "You participate in harmful stereotyping and potential defamation",
        explanation:
          "Falsely accusing people of criminal activity based on their possessions can destroy reputations and harm legitimate digital workers.",
        legalRisk:
          "False accusations of criminal activity constitute defamation and can result in serious legal consequences including lawsuits.",
      },
      {
        text: "Watch the videos without participating",
        points: 1,
        consequence: "You avoid direct participation but allow stigmatization to spread",
        explanation:
          "Passive consumption still supports the trend's popularity and doesn't challenge harmful stereotypes about digital work.",
      },
      {
        text: "Comment on videos: 'There are many legitimate ways to earn money online. We shouldn't assume someone is a scammer.'",
        points: 3,
        consequence: "You educate about legitimate digital careers",
        explanation:
          "Educating about legitimate online work helps counter stereotypes and supports students interested in digital careers.",
      },
      {
        ...
        points: 4,
        consequence: "You transform stigma into career education",
        explanation:
          "Perfect! Using harmful trends as opportunities for career education helps students understand the digital economy and reduces false accusations.",
        legalRisk:
          "Promoting legitimate career education and countering false stereotypes demonstrates leadership and helps protect people from defamation.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        points: 0,
        consequence: "You amplify dangerous anti-migration hate speech",
        explanation:
          "Anti-migration rhetoric has led to real violence and displacement in Cameroon. Your support contributes to dangerous divisions.",
        legalRisk:
          "Hate speech targeting internal migrants can result in legal consequences and contributes to conflicts that harm communities.",
      },
      {
        text: "Engage in the comment debates defending migrants",
        points: 2,
        consequence: "You defend migrants but may escalate online conflicts",
        explanation:
          "Defending migrants is important, but comment debates on inflammatory content often escalate rather than educate.",
      },
      {
        text: "Create your own reel celebrating how migration strengthens communities and brings diverse talents",
        points: 3,
        consequence: "You counter hate with positive messaging about migration",
        explanation:
          "Creating positive content about migration helps followers see the benefits of diversity and challenges anti-migration narratives.",
      },
      {
        ...
        points: 4,
        consequence: "You take comprehensive action to address migration hate",
        explanation:
          "Excellent! Combining immediate action with education and community building helps address both the content and underlying attitudes.",
        legalRisk:
          "Defending migration rights and promoting inclusion aligns with Cameroon's laws and demonstrates excellent citizenship.",
      },
    ],
  },
]